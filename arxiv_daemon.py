...
if __name__ == '__main__':
    ...
    # Computer Vision | Machine Learning | Computation and Language | AI |  Neural and Evolutionary Computing | Robotics
    ...
    for k in range(args.start, args.start + args.num, 100):
        ...
        if nnew == 0:
            ...
            if args.break_after > 0 and zero_updates_in_a_row >= args.break_after:
                logging.info("breaking out early, no new papers %d times in a row" %
                             (args.break_after, ))
                break
            elif k == 0:
